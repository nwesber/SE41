          ...
          <tr>
           ...
           <td>
              <form action="books/{{ $book{'_id'} }}" method="POST">
                {{ csrf_field() }}
                <input type="button" value="View" onclick="window.location='{{ route('books.show', ['book' => $book{'_id'}]) }}'"> &nbsp;
                <input type="button" value="Edit" onclick="window.location='{{ route('books.edit', ['book' => $book{'_id'}]) }}'"> &nbsp;
